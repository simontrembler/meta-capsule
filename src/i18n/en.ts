...
export const en: Record<TranslationKey, string> = {
  ...
  'settings.zipAccessValue': 'File System Access API (Chrome/Edge) — persisted handle, no file copy',
  ...
  'messages.reselectZip': 'Re-select the ZIP archive to view media',
  ...
  'gallery.zipMissing': 'ZIP not loaded',
  'gallery.zipMissingMemory': 'ZIP not loaded in memory',
  'gallery.voice': 'Voice',
